...
if __name__ == '__main__':
    ...
    x=args.model_output.split(".")[0]   
    ff=open("only_number/"+x+".bleu","w")	
    
    print (bleuFromMaps(goldMap, predictionMap,ff)[0])
    ff.close() 
